...
<form method="post">
		<input type="text" name="s" class="text" size="20" value="关键词搜索" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;"/>
</form>
</div>
...
<div class="container_16 clearfix" id="m4gocenter">
